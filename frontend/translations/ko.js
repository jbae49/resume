...
그렇지만,
어쩌면 한동안 한 가지에 집중하는 것이 맞을지도 모른다. 하지만 자꾸 떠오르는 스타트업 아이디어들이 내 주의를 끌고 있다. 솔직히 말하면 산만하다.

한 분야를 전문으로 해야 한다면, 아마도 데이터 사이언스나 코딩이었을 것이다.

하지만 지금 AI의 부상으로,
우리가 무엇을 배워야 하는지 혼란스럽다. 물론 기본 이론을 이해하는 것은 항상 가치가 있지만 - "처음부터 코딩을 배우는 것이 여전히 가치가 있을까?"
...
내면을 들여다보면,
나는 많은 것에 호기심이 있고 빨리 배운다. 하지만 일할 때 더 진지하고 집중해야 한다는 것도 안다.

일을 가볍게 생각하는 것이 아니다 - 그렇지 않다.

하지만 솔직히 말하면,
때로는 마음 깊은 곳에서, 일을 약간 장난스럽게 접근해도 성공할 수 있다고 생각한다.
...
다른 이야기로,
이상하게 들릴 수도 있지만, 실제로 미국으로 이주하기 전에 일본에서 시간을 보내고 싶다.
